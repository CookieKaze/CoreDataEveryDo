...
- (void)insertNewObject {
    ...
    Todo * todoItem = [NSEntityDescription insertNewObjectForEntityForName:@"Todo" inManagedObjectContext:context];
    // If appropriate, configure the new managed object.
    todoItem.title = @"TEST2";
    todoItem.complete = NO;
    todoItem.priority = 1;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(Todo*)todo {
...
- (NSFetchedResultsController<Todo *> *)fetchedResultsController
{
    ...
    NSFetchRequest<Todo *> *fetchRequest = [[NSFetchRequest alloc] init];
